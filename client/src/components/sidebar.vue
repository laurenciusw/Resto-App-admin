...
<template>
	<div  class="ml-auto mb-6 min-w-screen min-h-screen lg:w-[75%] xl:w-[80%] 2xl:w-[85%] px-6">
		<div class="space-y-3">
			...
			<div class="relative">
				...
				<input type="search" name="Search" placeholder="Search..." class="w-full py-2 pl-10 text-sm dark:border-transparent rounded-md focus:outline-none dark:bg-gray-800 dark:text-gray-100 focus:dark:bg-gray-900" wtx-context="5AD011CF-20B8-4792-B42D-60E5450D4248">
			</div>
			<div class="flex-1">
				<ul class="pt-2 pb-4 space-y-1 text-sm">
					...
					<li class="rounded-sm">
						<a @click.prevent="doLogout" rel="noopener noreferrer" href="#" class="flex items-center p-2 space-x-3 rounded-md">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
